                        ...
                        <div class="web_register web">
                            <div class="register_form">
                                <form action="" name="registerform" accept-charset="utf-8" id="register_form" method="post">
                                    ...
                                    <div class="col-xs-5 login-div1">
                                        <input type="text" name="yzh" class="form-control" style="width: 60%;display: inline;" placeholder="请输入验证码" />
                                    ...
                                    <div class="col-xs-5 login-div checkbox-img">
